...
class DeliveryOrderProductList : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setData()
        binding.filter.setOnCheckedChangeListener { _, _ -> getProductCategory() }
        ...
        mAdapter.setListener(object : ProductListAdapter.OnProductClickListener {
            override fun onProductClick(product: Product) {
                findNavController().navigate(
                    R.id.action_navigation_delivery_order_equipment_list_to_navigation_delivery_order_add_product_to_cart,
