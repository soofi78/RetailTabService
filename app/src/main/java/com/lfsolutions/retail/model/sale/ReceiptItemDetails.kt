...
data class ReceiptItemDetails(
    ...
    @SerializedName("actualAmount") var actualAmount: Int? = null,
    @SerializedName("balanceAmount") var balanceAmount: Int? = null,
    @SerializedName("applied") var applied: Boolean? = null,
    @SerializedName("appliedAmount") var appliedAmount: Int? = null,
    @SerializedName("roundingAmount") var roundingAmount: Int? = null,
